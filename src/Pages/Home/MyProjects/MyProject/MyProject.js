...
const MyProject = ({ project }) => {
  ...
  return (
    <Col xs={12} sm={6} md={4} className="mb-2 block m-auto">
      <Card>
        <div className="myProject-details">
          <Card.Img
            variant="top"
            src={picture1}
            className="img-fluid myProject-thumbnail"
          />
          ...
          <Card.Body className="myProject-hover-detail">
            ...
            <Button
              onClick={handleShow}
              variant="white"
              className="w-50 p-2 mt-4 detail-button"
            >
              View Details
            </Button>
          </Card.Body>
      ...
      >
        <Container>
          <Row style={{ backgroundColor: "#320037", color: "white" }}>
            <Col
              md={4}
              className="d-flex align-items-center justify-content-center py-4 ps-5"
            >
            ...
            <Col md={8}>
              ...
              <Modal.Footer>
                <a
                  href={liveSite}
                  target="blank"
                  className="text-decoration-none myProject-button"
                >
                  <Button
                    variant="none"
                    className="border-0 me-auto text-white"
                  >
                    Live Preview
                  </Button>
                </a>
                ...
                <a
                  href={githubClient}
                  target="blank"
                  className="text-decoration-none myProject-button me-auto"
                >
                ...
                {githubServer && (
                  <a
                    href={githubServer}
                    target="blank"
                    className="text-decoration-none myProject-button me-auto text-white"
                  >
                    <Button variant="none" className="text-white">
                      <FontAwesomeIcon icon={faGithub} className="me-1" />
                      Github Server
